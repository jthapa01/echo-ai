...
//  *  1. Generate an API key (from backend folder)
//  *    pnpm dlx convex run --component agent apiKeys:issue '{name:"test"}'
//  *  2. Open the playground:
//  *    Run -> pnpm dlx @convex-dev/agent-playground and enter your Convex deployment URL + API key

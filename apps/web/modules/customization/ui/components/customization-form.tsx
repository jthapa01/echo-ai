                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormDescription>
                                        The first message displayed when a user opens the widget.
                                    </FormDescription>
                                    <FormMessage />
                                </FormItem>
                            )}
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <p className="mb-4 text-muted-foreground text-sm">
                                    Quicky reply suggestions shown to customer to help guide the conversation
                                </p>
                                <div className="space-y-4">
                                    <FormField
                                        control={form.control}
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                <FormLabel>Suggestion1</FormLabel>
                                                <FormControl>
                                                    <Input
                                                        {...field}
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                <FormLabel>Suggestion2</FormLabel>
                                                <FormControl>
                                                    <Input
                                                        {...field}
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                <FormLabel>Suggestion3</FormLabel>
                                                <FormControl>
                                                    <Input
                                                        {...field}
                ...
                {hasVapiPlugin && (
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Configure voice calling features powerd by Vapi</CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-6">

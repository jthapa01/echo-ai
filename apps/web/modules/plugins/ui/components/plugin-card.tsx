        ...
        <div className="h-fit w-full rounded-lg border bg-background p-8">
            <div className="mb-6 flex items-center justify-center gap-6">
                <div className="flex flex-col items-center">
                    <Image alt={serviceName} className="rounded object-contain" height={40} width={40} src={serviceImage} />
                </div>
            ...
            <div className="mb-6 text-center">
                <p className="text-lg">Connect your {serviceName} account to the platform.</p>
            </div>
            <div className="mb-6">
            ...
            <div className="text-center">
                <Button disabled={isDisabled} onClick={onSubmit} className="size-full" variant="default">
                    Connect
                    <PlugIcon />
                </Button>
            </div>

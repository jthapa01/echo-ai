    ...
    return (
        <>
            <IntegrationsDialog
                ...
                script={selectedIntegration}
            />
            <div className="flex min-h-screen flex-col bg-muted p-8">
                <div className="mx-auto w-full max-w-screen-md">
                    <div className="space-y-2">
                        <h1 className="text-2xl md:text-4xl">Setup & Integrations</h1>
                        <p className="text-muted-foreground">Choose the integration that's right for your organization</p>
                    </div>
                    <div className="mt-8 space-y-6">
                        <div className="flex items-center gap-4">
                            <Label className="w-34" htmlFor="organization-id">Organization ID</Label>
                            <Input id="organization-id" disabled value={organization?.id ?? ""} readOnly className="flex-1 bg-background font-mono text-sm" />
                            <Button onClick={handleCopyClick} size="sm" className="gap-2">
                    ...
                    <div className="space-y-6">
                        <div className="space-y-1">
                            <Label className="text-lg">Available Integrations</Label>
                            <p className="text-muted-foreground text-sm">
                                Choose the integration code that's right for your organization
                            </p>
                        </div>
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-4">
                            {INTEGRATIONS.map((integration) => (
                                <button
                                    ...
                                    type="button"
                                    className="flex flex-col items-center gap-3 rounded-lg border bg-background p-6 text-center hover:bg-accent"
                                >
                                    <Image
            ...
            <DialogContent>
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-muted-foreground text-sm">
                            Paste the copied script into the HTML of your website, just before the closing &lt;/body&gt; tag.
                        </p>
                    </div>
                </div>
            </DialogContent>
